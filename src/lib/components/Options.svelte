...
<div class="fullscreen backdrop-blur-sm w-[100dvw] h-[100dvh] fixed top-0 left-0 flex justify-center items-center z-10"
    ...
    <div class="options rounded p-2 flex flex-col gap-2 w-11/12 max-w-screen-md">
        ...
        <button class="flex items-center w-full bg-transparent rounded cursor-pointer justify-between p-2 border-2 border-solid border-orange-400 text-orange-400" on:click={copy}>
        ...
        <button class="flex items-center w-full bg-transparent rounded cursor-pointer justify-between p-2 border-2 border-solid border-orange-400 text-orange-400" on:click={playNext}>
            <PlayNext/>
